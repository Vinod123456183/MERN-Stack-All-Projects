  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/2 bg-indigo-700 text-white  flex flex-col justify-center items-center p-10">
        <h1 className="text-4xl font-bold mb-4">LuckyJob</h1>
      ...
      <div className="w-1/2 bg-white flex justify-center items-center relative">
        ...
        <div className="bg-white dark:text-black rounded-xl p-10 shadow-xl w-[80%] max-w-md text-center">
          <p className="text-2xl font-bold mb-6">Sign up / Create An Account</p>
